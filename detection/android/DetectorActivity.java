...
//    private static final int YOLO_BLOCK_SIZE = 32;
    ...
    // TODO: Add custom model and labels here
  private static String TF_OD_API_MODEL_FILE = SaveModelPath.getInstance().getModelPath();
// private static  String TF_OD_API_LABELS_FILE = "file:///android_asset/object_detection_card.txt";
 private static  String TF_OD_API_LABELS_FILE = SaveModelPath.getInstance().getLabelPath();
  ...
  public void onClick(View v) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
       ...
       // ShowAlert.showToast(getApplicationContext(),"kena");
...
//      } else {
          try {
              ...
              if (SaveModelPath.getInstance().getModelPath() != null) {
                  ...
                  ShowAlert.showToast(getApplicationContext(), "File model belum dipilih");
                  finish();
              }
